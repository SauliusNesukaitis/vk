...
class Keyboard {
  ...
  init() {
    const title = createElement('h1', 'title', null, null, 'Virtual keyboard (Windows)');
    const keyboard = this.createKeyboard();
    const pOS = createElement('p', 'pOS', null, null);
    const pLang = createElement('p', 'language', null, null, 'Switch language: left ctrl + alt');
